...
SampleConfig = {
  ...
  "devices": {
    ...
    "AA:BB:CC:DD:EE:FF": VTDecoder(
      "solar", SolarCharger, "00000000000000000000000000000000"
    ),
    "AA:BB:CC:DD:EE:00": VTDecoder(
      "bms", BatteryMonitor, "11111111111111111111111111111111"
    ),
  },
